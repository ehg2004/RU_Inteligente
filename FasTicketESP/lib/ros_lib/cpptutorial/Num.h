#ifndef _ROS_cpptutorial_Num_h
#define _ROS_cpptutorial_Num_h
...
namespace cpptutorial
{
  ...
  class Num : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "cpptutorial/Num"; };
    virtual const char * getMD5() override { return "57d3c40ec3ac3754af76a83e6e73127a"; };
